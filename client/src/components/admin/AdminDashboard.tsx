...
const getActivityInfo = (action: string) => {
  switch (action) {
    ...
    case 'user_created':
      return {
        title: 'کاربر جدید',
        description: 'کاربر جدیدی ایجاد شد',
        icon: Users,
    ...
    case 'file_uploaded':
      return {
        title: 'آپلود فایل',
        description: 'فایل جدیدی آپلود شد',
        icon: Upload,
    ...
    case 'bank_card_created':
      return {
        ...
        description: 'کارت بانکی جدیدی اضافه شد',
        icon: CreditCard,
        color: 'bg-blue-100 dark:bg-blue-900 text-blue-600'
      };
    case 'bank_card_updated':
      return {
        ...
        description: 'کارت بانکی ویرایش شد',
        icon: CreditCard,
        color: 'bg-purple-100 dark:bg-purple-900 text-purple-600'
      };
