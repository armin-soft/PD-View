  ...
  const deleteUserMutation = useMutation({
    ...
    onError: (error: any) => {
      toast({
        ...
        description: error.message || 'عملیات حذف کاربر ناموفق بود. لطفاً دوباره تلاش کنید.',
        variant: 'destructive'
      });
    },
  });
                          ...
                          <TableCell>
                            <div className="flex items-center justify-center gap-2">
                              ...
                              <Button
                                ...
                                size="sm"
                                onClick={() => {
                                  if (window.confirm(`آیا از حذف کاربر ${user.firstName} ${user.lastName} اطمینان دارید؟`)) {
