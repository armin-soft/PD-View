...
export function BankCardManagement() {
  ...
  const { data: bankCards, isLoading } = useQuery({
    queryKey: ['/api/admin/bank-cards', searchQuery, statusFilter],
    queryFn: async () => {
                    ...
                    >
                      ...
                      <div className="absolute top-3 right-4 flex items-center gap-3 text-white">
                        <div className="w-10 h-10 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center border border-white/30 shadow-lg">
                          <i className={`ibl ${bankInfo.logoClass}`} style={{ 
                            fontSize: '20px',
                            color: 'white',
                  ...
                  <div className="relative w-full max-w-sm mx-auto aspect-[1.6/1] perspective-1000">
                    ...
                    >
                      ...
                      <div className="absolute top-4 right-4 flex items-center gap-3">
                        ...
                        <div className="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center border border-white/30 shadow-xl">
                          <i className={`ibl ${previewBankInfo.logoClass}`} style={{ 
                            fontSize: '24px',
                            color: 'white',
                            filter: 'brightness(0) invert(1)'
                          }}></i>
