      ...
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 sm:h-18 items-center justify-between">
            ...
            >
              { }
              {isAuthenticated && location !== '/admin' && (
                <motion.div 
                ...
                >
                  <Button
                    variant="ghost"
                    size="sm"
                    className="relative w-10 h-10 rounded-xl bg-gradient-to-br from-gray-100/80 via-white/80 to-gray-100/80 dark:from-gray-800/80 dark:via-gray-700/80 dark:to-gray-800/80 hover:from-orange-100/80 hover:to-yellow-100/80 dark:hover:from-orange-900/20 dark:hover:to-yellow-900/20 border border-gray-200/50 dark:border-gray-700/50 transition-all duration-300 overflow-hidden group"
                  >
                    ...
                    <Bell className="h-4 w-4 text-gray-600 dark:text-gray-400 relative z-10" />
                    {notificationCount > 0 && (
                      <motion.div
                        className="absolute -top-1 -right-1 min-w-[18px] h-4.5 bg-gradient-to-r from-red-500 to-pink-500 rounded-full flex items-center justify-center"
                        animate={{ scale: [1, 1.2, 1] }}
                        transition={{ duration: 2, repeat: Infinity }}
                      >
                        <span className="text-[10px] font-bold text-white px-1">
                          {notificationCount > 9 ? toPersianDigits('9+') : toPersianDigits(notificationCount)}
                        </span>
                      </motion.div>
                    )}
                  </Button>
