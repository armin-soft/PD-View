  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-100/50 dark:from-slate-900 dark:via-blue-950/30 dark:to-indigo-950/50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        />
        <motion.div 
          className="absolute top-1/2 left-1/2 w-60 h-60 bg-gradient-to-r from-violet-400/15 to-pink-600/15 rounded-full blur-3xl"
          animate={{ 
            x: [0, 150, -150, 0],
            y: [0, -100, 100, 0],
            scale: [1, 0.8, 1.3, 1]
        ...
        >
          ...
          <div className="relative flex flex-col lg:flex-row lg:items-center justify-between gap-6">
            <div className="flex items-center gap-6">
              ...
              >
                <motion.div
                  className="absolute inset-0 bg-gradient-to-br from-blue-400 via-purple-400 to-pink-400 rounded-2xl blur-xl opacity-60"
